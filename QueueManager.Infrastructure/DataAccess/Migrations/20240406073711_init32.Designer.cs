...
namespace QueueManager.Infrastructure.Migrations
{
    ...
    [Migration("20240406073711_init32")]
            ...
            modelBuilder.Entity("QueueManager.Domain.Models.BusinessModels.Doctor", b =>
                {
                    ...
                    b.HasOne("QueueManager.Domain.Models.BusinessModels.DoctorRating", "RatingId")
                        .WithMany("Doctors")
                        .HasForeignKey("RatingIdId");

                    b.Navigation("Category");

                    b.Navigation("RatingId");
                });
